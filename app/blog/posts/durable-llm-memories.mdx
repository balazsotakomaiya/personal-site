...
summary: 'LLMs are stateless. So what would it take to give them memory?'
image: '/llm1.jpg'
draft: 'false'
---
...
The practical consensus across most of the recent literature: **embeddings alone are not memory**. Semantic search is one component, but memory quality is mostly determined by write discipline, retrieval ranking, temporal modeling, and what you do with contradictions.
